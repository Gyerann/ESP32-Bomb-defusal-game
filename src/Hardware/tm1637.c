...
void tm1637_start(tm1637_led_t * led)
{
    ...
    //ESP_LOGI("tm1637 start", "Data pin set to 0");
    tm1637_delay();
}
...
void tm1637_stop(tm1637_led_t * led)
{
    ...
    gpio_set_level(led->m_pin_dta, 0);
    //ESP_LOGI("tm1637 stop1", "Data pin set to 0");
    tm1637_delay();
    gpio_set_level(led->m_pin_clk, 1);
    //ESP_LOGI("tm1637 stop2", "CLK pin set to 1");
    tm1637_delay();
    gpio_set_level(led->m_pin_dta, 1);
    //ESP_LOGI("tm1637 stop3", "Data pin set to 1");
    tm1637_delay();
}
